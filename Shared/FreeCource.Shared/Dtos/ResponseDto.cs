...
namespace FreeCourse.Shared.Dtos
{
	public class ResponseDto<T>
	{
		...
		// STATIC FACTORY METHODS;statik metotlarla beraber geriye yeni nesne dönüyoruz.
		...
		{
			return new ResponseDto<T> { Errors = errors, Data = default(T), StatusCode = statusCode, IsSuccessful = false };
		}
